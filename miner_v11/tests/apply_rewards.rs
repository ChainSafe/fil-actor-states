...
use fil_actors_runtime_v11::test_utils::REWARD_ACTOR_CODE_ID;
use fil_actors_runtime_v11::BURNT_FUNDS_ACTOR_ADDR;
use fil_actors_runtime_v11::REWARD_ACTOR_ADDR;
use fil_actors_runtime_v11::STORAGE_POWER_ACTOR_ADDR;
...
fn funds_vest() {
    ...
    assert!(acc
        ...
        .first()
        .unwrap()
        .contains("DeadlineCronActive == false"));
}
...
fn rewards_pay_back_fee_debt() {
    ...
    assert_eq!(
        available_before + reward - init_fee_debt - &remaining_locked,
        available_balance
    );
