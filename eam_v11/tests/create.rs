...
use fil_actors_runtime_v11::runtime::Primitives;
...
fn call_create_new() {
    ...
    let evm_params = eam::ext::evm::ConstructorParams {
        creator: eth_addr,
...
fn call_resurrect() {
    ...
    let params = eam::ext::evm::ConstructorParams {
        creator: caller_eth_addr,
        initcode: initcode.into(),
    };
...
pub fn construct_and_verify() -> MockRuntime {
    ...
    let result = rt
        .call::<eam::EamActor>(eam::Method::Constructor as u64, None)
        .unwrap();
    expect_empty(result);
    rt.verify();
    rt.reset();
