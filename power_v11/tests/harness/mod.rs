...
use fil_actors_runtime_v11::runtime::RuntimePolicy;
use fil_actors_runtime_v11::test_utils::CRON_ACTOR_CODE_ID;
use fil_actors_runtime_v11::Multimap;
use fil_actors_runtime_v11::CRON_ACTOR_ADDR;
use fil_actors_runtime_v11::REWARD_ACTOR_ADDR;
...
impl Harness {
    pub fn construct(&self, rt: &MockRuntime) {
        ...
        rt.call::<PowerActor>(Method::Constructor as MethodNum, None)
            .unwrap();
        rt.verify()
    }
    ...
    pub fn list_miners(&self, rt: &MockRuntime) -> Vec<Address> {
        ...
        keys.iter()
            .map(|k| Address::from_bytes(k).unwrap())
            .collect::<Vec<_>>()
    }
