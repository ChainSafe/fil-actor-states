...
var EmbeddedBuiltinActorsMetadata []*BuiltinActorsMetadata = []*BuiltinActorsMetadata{{
	...
	ManifestCid:  MustParseCid("bafy2bzaceajywp2xhkhujalnai7aqren3qyaxqgp5u3ezeoshr76xxlds3w3c"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacecr3ve6gdwzyqnzn6dhl2tmyharywgmle6zhro4qdkjk5qupxv2u6"),
		"cron":             MustParseCid("bafk2bzaceank47m3ihy7dopmxlidsxvcizmjwhy24ns4weo6hhfr4qspxiju2"),
		"datacap":          MustParseCid("bafk2bzaceccvvscysuzw3omrpwdevkq5hbozejpioe4jrr6vb2kcrnpudhv26"),
		"eam":              MustParseCid("bafk2bzacebn67os3c7lexcrsaqce5nejdlbdj5ecyuybg7u44kuhqx3g6a23i"),
		"ethaccount":       MustParseCid("bafk2bzaceca5qfmh7bgvrzb5vsfuzmnepuv4mckzg2lbos47zylsbzeepr2r2"),
		"evm":              MustParseCid("bafk2bzacec7r4augyisymeuhhmsimtztoaqleez2qn22xtuur5vsml25xc2uw"),
		"init":             MustParseCid("bafk2bzaced5devnmui7zqlcdy626r373snycrejoeiae5dh5cqfxskiji2csq"),
		"multisig":         MustParseCid("bafk2bzaceb34rjnrsybhjtp5cxcftusahgbrk3nsrsbybyzclvosp2shssjhi"),
		"paymentchannel":   MustParseCid("bafk2bzaceb642lj7nc4zqqf2w42h67aupzc7jnmtmkrxvc6cc426qvgf6o6dg"),
		"placeholder":      MustParseCid("bafk2bzacedfvut2myeleyq67fljcrw4kkmn5pb5dpyozovj7jpoez5irnc3ro"),
		"reward":           MustParseCid("bafk2bzacec45uc4oc2itplgzsuuctcegufhbub65efct23y47jevvjfxg4tpc"),
		"storagemarket":    MustParseCid("bafk2bzacec2fnbbyn3fed2m5mde2athyf35wkwmtcjibi2oh7evepyt44f6z6"),
		"storageminer":     MustParseCid("bafk2bzacebkkpupaqfipwflw3k5dipggyjiuuesfwzoabsahclq3wgz6cysjc"),
		"storagepower":     MustParseCid("bafk2bzacectnsk2yv3kqazdp4oz5j24digj4vo5yj7s5fenh5izsofgfnk4nc"),
		"system":           MustParseCid("bafk2bzacea3tpw2wvvhser4c62qm4jtxtn2dmnbxdamb23gofqasqfrzmch6w"),
		"verifiedregistry": MustParseCid("bafk2bzacec6nfnxn6ffvpld65oabfqitj76yor32qavwjlq7wwfuuokmbsoy6"),
	},
}, {
	...
	Version:      14,
	BundleGitTag: "v14.0.0",
	ManifestCid:  MustParseCid("bafy2bzaceceidqzsz325wky4iche37m2l2cd2gtypjjnz2xszrcuywfjqxgis"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacecsisvnhz547f5iiytqsrvgeyzgieahqhrgtf55c2x2gs2ooq5x5a"),
		"cron":             MustParseCid("bafk2bzaceau3chmja3diu5qlyuxkdy2pmmhstueplovwvwtfao5zohkhrnyu4"),
		"datacap":          MustParseCid("bafk2bzacebdqm3bpupesqy3chhkm3xcmxiytba33tipxef3he7av3goyj4yw6"),
		"eam":              MustParseCid("bafk2bzacebcdl4vrwr4hmzosqd4qrst7ia6okwv73ezkw2275c3asm77bdlk6"),
		"ethaccount":       MustParseCid("bafk2bzacear6ssfnh6wjdhui5xbibakgqie54wpw2jxwd33be5eqz463xzmby"),
		"evm":              MustParseCid("bafk2bzaceb2j5uguwuse4m6texmpornseajkkvlw7bojrljrbaimuerb5l2yi"),
		"init":             MustParseCid("bafk2bzacebteljnpcv47qmycm2i3nzossyl2wicu3nwz7dyzfnvsn7ruho67k"),
		"multisig":         MustParseCid("bafk2bzaceagfkwt2etnk6u5fqznahiedzvmwjznikd34fptideofp3xls6cia"),
		"paymentchannel":   MustParseCid("bafk2bzaced5pltotbcnjidz2664j5pr5nh74hmmahavgtanijjlfngsuryjv6"),
		"placeholder":      MustParseCid("bafk2bzacedfvut2myeleyq67fljcrw4kkmn5pb5dpyozovj7jpoez5irnc3ro"),
		"reward":           MustParseCid("bafk2bzacebxouhrgsn2yiueivpr73hd4dknhqjqcycs7akbdm6zryl2xm2l66"),
		"storagemarket":    MustParseCid("bafk2bzacebvcrmruubqm6a2howonstbmlyauevuw2rof3pqemye6oajnjdyk2"),
		"storageminer":     MustParseCid("bafk2bzaceahvzgw4citdexoy4nhsg5rd75wvyl6vukhzo2n33bkwumnf75bxs"),
		"storagepower":     MustParseCid("bafk2bzacebr2cu7rinlx34zzqebhq77wgfhi5wmkme5kj3ptfrnu2mu67rbwm"),
		"system":           MustParseCid("bafk2bzacebrxo5nxy3yy5lrfzy5tlcbmofcvi7vzfg7d7v6pt4wn5rvo234g6"),
		"verifiedregistry": MustParseCid("bafk2bzacedbwzmbtpvc3b2f6f657ajipdh2tfyxjbrcajinpervq6xqfdegd6"),
	},
}, {
	...
	Version:      14,
	BundleGitTag: "v14.0.0",
	ManifestCid:  MustParseCid("bafy2bzacebgmsnk7hzuwnn5ftu6lw5n5zb3mdkijilro65wmdxtvgpflcxtws"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzaceaotw53cmuvyabkw4x76rzmmwiodmmsmoasiyifzsllnhzicpgsxy"),
		"cron":             MustParseCid("bafk2bzaceb6nuwgxxfa2ivaord7nwmyakiheaogtbvmicrelm3skmfybpch2c"),
		"datacap":          MustParseCid("bafk2bzacedgnxljxt3gzrpjzyhwt6alcyn557bfcuwhcqjexbrklaaahpmweg"),
		"eam":              MustParseCid("bafk2bzacebhrn5gcu5m46zwcx4ryui4ijwjy57mq3e5ao2fae52isk72qsv62"),
		"ethaccount":       MustParseCid("bafk2bzacea2rwpbj2utau3pjxs6hyliau7qjvu6zqkseubtfv75sqexalfmag"),
		"evm":              MustParseCid("bafk2bzaceaojjqn3xwrvh6f65awb2qxp5yi4lz6sg3zfgdc2bismbz5k2j44y"),
		"init":             MustParseCid("bafk2bzacedykzuzfxtr3hz3s7eyjcwjanf4istflrpsq2a3sj4bxp5seyu5ma"),
		"multisig":         MustParseCid("bafk2bzacedk44m53jkvpi2tku3zyn5li7cgm43oajtpg3qvblzymbbsha6beo"),
		"paymentchannel":   MustParseCid("bafk2bzacedx7xr3dr6dn6amq7luk4txsjiwbrhwnchkto4lnmr4s27hkw37hw"),
		"placeholder":      MustParseCid("bafk2bzacedfvut2myeleyq67fljcrw4kkmn5pb5dpyozovj7jpoez5irnc3ro"),
		"reward":           MustParseCid("bafk2bzacedrvq7ezro65cdquxka5tjctgx7ufeevauaucgc53p53hqgzfhpna"),
		"storagemarket":    MustParseCid("bafk2bzacecwv2wwbecipdhc7ktyxl44yx7secn66qkbkucfsplwicw7yv5psi"),
		"storageminer":     MustParseCid("bafk2bzaceahv27z7aowtbxiwqogqbg53acij3r3udqigff44zimtal3dpdd52"),
		"storagepower":     MustParseCid("bafk2bzaceah4u7to7a7qaodp7bmevfpgos5iwn42t32uooukifm5yv37acrgu"),
		"system":           MustParseCid("bafk2bzacecd3t27jkvkxynybo5d2plzcoiglxvra4y7e4lwkqkorge6dk2dli"),
		"verifiedregistry": MustParseCid("bafk2bzacecuplx6mlmonxzr75g5zumbfjcq53iojf7brr2xkjxrpcxlu6nmm2"),
	},
}, {
	Network: "devnet",
	Version: 8,
	...
	Version:      14,
	BundleGitTag: "v14.0.0",
	ManifestCid:  MustParseCid("bafy2bzaceacis6g5kmylgtgawnt474rnyzk37ggjtihechnpskjqfyp4kxf4a"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacedo5nu6c5ffai762ax5cbqnsbg3togut7s5qdslluhiomzobmfay4"),
		"cron":             MustParseCid("bafk2bzaceait4oqzjrkgcgl2nbcdgdeefpdrj27mdux6u4vbkukl2adkmpwci"),
		"datacap":          MustParseCid("bafk2bzaceaaijaq4fxsl5mwegt6qoicoml7y5mrgmut4wgu2fzjs2nc3skkru"),
		"eam":              MustParseCid("bafk2bzacea6ngwwt2ixwyugmemyiqnfltlme7lveuly4wnlsdrtnw7owdwou4"),
		"ethaccount":       MustParseCid("bafk2bzacecxajvircazsvxcvwjrodscak3wzqgbz4gigtfrno6yj4sctgzrkc"),
		"evm":              MustParseCid("bafk2bzaceb3idq4cayisqw345mwvsry4oxbzzdcmts33aivzkr4je27dx7n6u"),
		"init":             MustParseCid("bafk2bzaced5noa7mir6244xpw3ezuidwmw6mecziijstuqcnyr2ceybudsrnk"),
		"multisig":         MustParseCid("bafk2bzacebhkzfpp7uf5suqszagockjecy5ubvc22qdubi75uy4iu5kmhgicu"),
		"paymentchannel":   MustParseCid("bafk2bzacebgb42xwlzhuynryyjwem5qbpf6ro3ak2cdvd5nlle4cumwcg6ux4"),
		"placeholder":      MustParseCid("bafk2bzacedfvut2myeleyq67fljcrw4kkmn5pb5dpyozovj7jpoez5irnc3ro"),
		"reward":           MustParseCid("bafk2bzaceaeh5s2sksulmzi7kiiyphhp2irnlqpofjcq2i5ywfoorstohjsoq"),
		"storagemarket":    MustParseCid("bafk2bzaceatoguxb5qlhpsb3nwj5judnkmrt3nsyfozliwfw4jomsc3cxbst4"),
		"storageminer":     MustParseCid("bafk2bzaceczw4d7vpmkslh6ahelp5lcqczxddhwsroa5cfv5yonq7nqklbuz4"),
		"storagepower":     MustParseCid("bafk2bzacebsi5izrtvo4g6vzlz2ywbluiqftgit77gv5pfaggpr7xu7nmr6pw"),
		"system":           MustParseCid("bafk2bzacecury57phjb7ctacyera545m37uvgoijqr72iu5yf7fcp46lscvba"),
		"verifiedregistry": MustParseCid("bafk2bzaceaf4dkpmjp7gufkc544lnh5ymbb5bgk47uukjk3i3axtyc7mvfl3s"),
	},
}, {
	Network: "hyperspace",
	Version: 8,
	...
	Version:      14,
	BundleGitTag: "v14.0.0",
	ManifestCid:  MustParseCid("bafy2bzacebwlmjz4uy4l3cfa2ds7gg4mi25gxdh6ymbot4d43grbfzlkvfqoc"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacealievylreetnlk7zpud3varsheian26xwjpp5nvbwxgcnztg4cxc"),
		"cron":             MustParseCid("bafk2bzaceamlbwpbyejqlnjnp6qs4i2id4nzckfkp3n7eztpl4dvh7sw6iqog"),
		"datacap":          MustParseCid("bafk2bzacedyqae5amrm4z5on7kj7pyhg5yyhftoyxz73uae2hca3huy5rxlny"),
		"eam":              MustParseCid("bafk2bzacedjtfjtbrsobss4uex7g2vtzbruxpc5k3gig3ays6jeiflasuxlha"),
		"ethaccount":       MustParseCid("bafk2bzacecea4r2wtqtqgdyhn4n5kkle4ievgmhckx6b5p324qqokcgkbnrlk"),
		"evm":              MustParseCid("bafk2bzacebmbbvd634tgpetjihb343kskggu32kwfav2syitf4kyc4q4xofni"),
		"init":             MustParseCid("bafk2bzaceczjpfjquyeeujbn2vetmzrt7kvshz7yephzd7lgtvfvptga6njom"),
		"multisig":         MustParseCid("bafk2bzacecsb4lxvkcv6nt63xdwd73ambexizpznp52joeh7ev3tzu3jvpr3e"),
		"paymentchannel":   MustParseCid("bafk2bzaceafrne3ujbm2wrecsy333iso77x2rmfhtsisabuxkghzegvo7rbow"),
		"placeholder":      MustParseCid("bafk2bzacedfvut2myeleyq67fljcrw4kkmn5pb5dpyozovj7jpoez5irnc3ro"),
		"reward":           MustParseCid("bafk2bzacecoftrgm7cfk6mo2iy4akcq5yc4jkaanp5kv7ciwnw67ur6qmrbt2"),
		"storagemarket":    MustParseCid("bafk2bzacecgqihwu5xb4oiflxd5f4xcgb3irtwbsa4xsxwrqbzc6d5t732jxa"),
		"storageminer":     MustParseCid("bafk2bzacea37lcstq6ltoufcjbqxqm72cmadiuur7wofwgq6t77mz554owe4y"),
		"storagepower":     MustParseCid("bafk2bzacecvh6xvzzgizcrpkgnhnmsa5u3q742ym5e6bklz7qol5bs6rhtddy"),
		"system":           MustParseCid("bafk2bzaceb4i6hvzdo5mszuptfor4jzbvxohlsickofkerzq36yzjb3c6ydz4"),
		"verifiedregistry": MustParseCid("bafk2bzacedyvjc5hhzjj5hnifzky5msij5b5kvfuemedno7gak3tg6ddzfj6c"),
	},
}, {
	Network: "testing",
	Version: 8,
	...
	Version:      14,
	BundleGitTag: "v14.0.0",
	ManifestCid:  MustParseCid("bafy2bzaceaqopzb3mqhzr4nchuvu7ldko6sdkxvgrxbejnfu5sq27id5vnbke"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacebogevr6epoj5hu5xl53w4pygx7ed4dthg2wkvszzijjatey7a5xa"),
		"cron":             MustParseCid("bafk2bzacebsc4m3y3bncrxzawoljn5aqty6sp76snlmuyr5l7x4d6vlws45tc"),
		"datacap":          MustParseCid("bafk2bzacebtrafu676iihki5pnqvyxgebwe6zwo6xzfj6jmbf5eosxgzskpa2"),
		"eam":              MustParseCid("bafk2bzacedrhvfnwklpfjec522u634p4w7gizprex6fxmqpddncwmzmc54svy"),
		"ethaccount":       MustParseCid("bafk2bzacec4ozjjhr236xdizfeyxg67vrunmaalkkdkjq7sgrslkhwob2bl7o"),
		"evm":              MustParseCid("bafk2bzaceaoxy3hi3n6gx7eawrqol45ipjcycg2wn3u4ctqhetltkha2vteua"),
		"init":             MustParseCid("bafk2bzacedwh4wmx3ccdezc4oxjpylyxvo5dgnuldd43asm7qcauubmr5xvkw"),
		"multisig":         MustParseCid("bafk2bzaceb4lowwjjfjc4p2tfok3vveqzolzjmyeg3humhrn2jio4aubxcjtu"),
		"paymentchannel":   MustParseCid("bafk2bzacedm3tidzgfsljnbsxskxzvps7wtefvcmvmwilosfwcj7iobsggd7o"),
		"placeholder":      MustParseCid("bafk2bzacedfvut2myeleyq67fljcrw4kkmn5pb5dpyozovj7jpoez5irnc3ro"),
		"reward":           MustParseCid("bafk2bzaceb7735r2b4nwq4f7jby3bcvaf7kmj3lrqegzqd3hwsk6wd2jdiwye"),
		"storagemarket":    MustParseCid("bafk2bzaceajooc5qzupk76rom2gggpgirp5wiouporm62izla565gojfqxiw4"),
		"storageminer":     MustParseCid("bafk2bzaceaj4xzauwijm6xf33oh75epm2eadwwjtvuuos3bppok43we6f4v4k"),
		"storagepower":     MustParseCid("bafk2bzacebvfa4zic44dczttnsimhn7oua3o6pcpbon2hdkw3ugzn3jj32grg"),
		"system":           MustParseCid("bafk2bzacebijmbnihisnke3yejzsqjgeweyco6v3qhktch3yo6igmb3clic6i"),
		"verifiedregistry": MustParseCid("bafk2bzacea3ydq3omfkfljvlsvzntm4sys5ys3mt64ni4vjd64bwcmcg5gadc"),
	},
}, {
	...
	Version:      14,
	BundleGitTag: "v14.0.0",
	ManifestCid:  MustParseCid("bafy2bzacebxrydso6xpmwv2ndv6v4y4hgocqqyaf7gme53pscrce747rulmxu"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacebogevr6epoj5hu5xl53w4pygx7ed4dthg2wkvszzijjatey7a5xa"),
		"cron":             MustParseCid("bafk2bzacebsc4m3y3bncrxzawoljn5aqty6sp76snlmuyr5l7x4d6vlws45tc"),
		"datacap":          MustParseCid("bafk2bzacebtrafu676iihki5pnqvyxgebwe6zwo6xzfj6jmbf5eosxgzskpa2"),
		...
		"evm":              MustParseCid("bafk2bzaceaoxy3hi3n6gx7eawrqol45ipjcycg2wn3u4ctqhetltkha2vteua"),
		"init":             MustParseCid("bafk2bzacedwh4wmx3ccdezc4oxjpylyxvo5dgnuldd43asm7qcauubmr5xvkw"),
		"multisig":         MustParseCid("bafk2bzacedpqz6vjsv5sil6fvzhfgqy3ioveqa5gimnii6dr3yimdz5ajl6pe"),
		"paymentchannel":   MustParseCid("bafk2bzacedm3tidzgfsljnbsxskxzvps7wtefvcmvmwilosfwcj7iobsggd7o"),
		"placeholder":      MustParseCid("bafk2bzacedfvut2myeleyq67fljcrw4kkmn5pb5dpyozovj7jpoez5irnc3ro"),
		"reward":           MustParseCid("bafk2bzaceb7735r2b4nwq4f7jby3bcvaf7kmj3lrqegzqd3hwsk6wd2jdiwye"),
		"storagemarket":    MustParseCid("bafk2bzaceajooc5qzupk76rom2gggpgirp5wiouporm62izla565gojfqxiw4"),
		"storageminer":     MustParseCid("bafk2bzacedo3ku6stpg7xej6xx2h77p37hjenvxy7f3xwtej552x367s4tdsw"),
		"storagepower":     MustParseCid("bafk2bzacebvfa4zic44dczttnsimhn7oua3o6pcpbon2hdkw3ugzn3jj32grg"),
		"system":           MustParseCid("bafk2bzacebijmbnihisnke3yejzsqjgeweyco6v3qhktch3yo6igmb3clic6i"),
		"verifiedregistry": MustParseCid("bafk2bzacea3ydq3omfkfljvlsvzntm4sys5ys3mt64ni4vjd64bwcmcg5gadc"),
	},
