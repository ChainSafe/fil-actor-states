...
use crate::v19::{DistributionInit, PendingWriteOp, RecipientShare, StreamId, WeightRecordUpdate};
...
pub use fil_actors_shared::v19::builtin::reward::ThisEpochRewardReturn;
...
pub struct RegisterStreamParams {
    pub id: StreamId,
    pub weight: crate::v19::WeightRecord,
