...
//!
//! The record a stream persists is [`WeightRecord`], in [`crate::v19::state`]; the update and payload
//! shapes an SWA call carries it in are in [`crate::v19::types`].
...
use crate::v19::state::{DENOM, WeightRecord};
