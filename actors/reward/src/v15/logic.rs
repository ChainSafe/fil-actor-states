...
use fil_actors_shared::v15::builtin::reward::math::PRECISION;
...
mod tests {
    ...
    fn test_baseline_reward() {
        ...
        let filename = "src/v15/testdata/TestBaselineReward.golden";
        let golden_contents =
    ...
    fn test_simple_reward() {
        ...
        let filename = "src/v15/testdata/TestSimpleReward.golden";
        let golden_contents =
            fs::read_to_string(filename).expect("Something went wrong reading the file");
