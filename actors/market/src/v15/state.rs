...
use fil_actors_shared::v15::DealWeight;
...
use crate::v15::balance_table::BalanceTable;
use crate::v15::ext::verifreg::AllocationID;
...
impl State {
        ...
        BS: Blockstore,
    {
        ...
        if &prev_locked + amount > escrow_balance {
            return Err(actor_error_v15!(insufficient_funds;
