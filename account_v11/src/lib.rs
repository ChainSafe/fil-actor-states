...
use fil_actors_runtime_v11::builtin::singletons::SYSTEM_ACTOR_ADDR;
use fil_actors_runtime_v11::runtime::{ActorCode, Runtime};
use fil_actors_runtime_v11::{actor_dispatch, ActorDowncast, FIRST_EXPORTED_METHOD_NUMBER};
...
impl Actor {
    ...
    pub fn authenticate_message(
        ...
        rt.verify_signature(&sig, &address, &params.message)
            .map_err(|e| {
                e.downcast_default(
