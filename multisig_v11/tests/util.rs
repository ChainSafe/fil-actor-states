...
use fil_actors_runtime_v11::{make_map_with_root, ActorError};
...
impl ActorHarness {
    ...
    pub fn approve(
        ...
        let approve_params = TxnIDParams {
            id: txn_id,
            proposal_hash: Vec::<u8>::from(proposal_hash),
        };
        let ret = rt.call::<Actor>(
    ...
    pub fn lock_balance(
        ...
        rt.expect_validate_caller_addr(vec![rt.receiver]);
        let lock_balance_params = LockBalanceParams {
            start_epoch: start,
