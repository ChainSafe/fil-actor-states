...
modify-forest:
	...
	sed -i -e 's|fil_actor_init_state = "4"|fil_actor_init_state = { path =  "../actors/init" }|g' ./forest/Cargo.toml
	sed -i -e 's|fil_actor_miner_state = "4"|fil_actor_miner_state = { path =  "../actors/miner" }|g' ./forest/Cargo.toml
	sed -i -e 's|fil_actor_power_state = "4"|fil_actor_power_state = { path =  "../actors/power" }|g' ./forest/Cargo.toml
	sed -i -e 's|fil_actor_system_state = "4"|fil_actor_system_state = { path =  "../actors/system" }|g' ./forest/Cargo.toml
