...
lazy_static! {
    static ref NUM: Vec<BigInt> = poly_parse(&[
    ...
    .unwrap();
    static ref DENOM: Vec<BigInt> = poly_parse(&[
    ...
    static ref LN_2: BigInt = "235865763225513294137944142764154484399".parse().unwrap();
    static ref EPSILON: BigInt = "302231454903657293676544".parse().unwrap();
}
...
// public to parent for testing.
pub(super) fn ln(z: &BigInt) -> BigInt {
