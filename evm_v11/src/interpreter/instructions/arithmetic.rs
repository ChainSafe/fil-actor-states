...
mod test {
    mod basic {
        ...
        fn test_addmod() {
            ...
            assert_eq!(
                addmod(U256::MAX, U256::MAX, 4.into()),
                2,
                "max + max % 4 = 2"
            );
        }
        ...
        fn test_mulmod() {
            ...
            assert_eq!(
                mulmod(U256::MAX, U256::MAX, 2.into()),
                1,
                "max * max % 2 = 1"
            );
        }
        ...
        fn test_sub() {
            ...
            assert_eq!(
                sub(0.into(), 1.into()),
                U256::max_value(),
                "wrap around to max by one"
            );
            // wrap all limbs
            assert_eq!(
                sub(U256::max_value(), U256::max_value()),
                0,
                "wrap around zero by 2^256"
            );
        }
        ...
        fn test_modulo() {
            assert_eq!(
                modulo(0.into(), 0.into()),
                0,
                "nothing mod nothing is nothing"
            );
