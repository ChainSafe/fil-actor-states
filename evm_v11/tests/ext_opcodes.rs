...
use fil_actors_runtime_v11::runtime::{Primitives, Runtime, EMPTY_ARR_CID};
...
"#;
    ...
    rt.store
        .put_keyed(&bytecode_cid, bytecode.as_slice())
        .unwrap();
...
precompile:
    ...
    rt.store
        .put_keyed(&bytecode_cid, other_bytecode.as_slice())
        .unwrap();
